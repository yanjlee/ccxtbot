...
setuptools.setup(
    ...
    description="This is a pet project to get familiar with a number of APIs for trading cryptocurrencies via algorithms.",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/ccxtbot",  # 模块github地址
